...
export default function CollectionTile({
  ...
  return (
    ...
    >
      ...
      <div className="flex w-full flex-col gap-2 overflow-clip rounded-sm bg-[linear-gradient(to_bottom,color-mix(in_srgb,var(--theme-color)_10%,white),white_50%)] pb-5">
